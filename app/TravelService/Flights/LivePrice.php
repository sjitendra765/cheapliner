...
namespace App\TravelService\Flights;

use App\TravelService\TravelService;
use App\Traits\ImageTrait;
use App\Traits\ConsoleTrait;

class LivePrice extends TravelService
{
    use ImageTrait;
     ...
     * @var string
     */
    protected $carrierschema = 'Skyscanner';
    ...
    public function getUrl()
    {
        ...
        $sessionKey = $this->getSessionKey($url);
