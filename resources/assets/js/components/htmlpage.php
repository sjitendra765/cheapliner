        ...
        <header id="fh5co-header-section" class="sticky-banner">
            <div class="container">
                <div class="nav-header">
                    ...
                    <h1 id="fh5co-logo"><a href="index.html"><i class="icon-airplane"></i>Cheapliner</a></h1>
                    <!-- START #fh5co-menu-wrap -->
                    <nav id="fh5co-menu-wrap" role="navigation">
                        <ul class="sf-menu" id="fh5co-primary-menu">
                            <li>
                                <a href="vacation.html" class="fh5co-sub-ddown">Currency</a>
                                  ...
                                  <!-- Nav tabs -->
                                   ...
                                   <!-- Tab panes -->
                                    <div class="tab-content">
                                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/searchResult') }}">
                                     {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            <div class="col-xxs-12 col-xs-6 mt">
                                                <div class="input-field">
                                                    ...
                                                    <input type="text" class="form-control" id="from-place" name="from-place" placeholder="Los Angeles, USA"/>
                                                </div>
                                            </div>
                                            <div class="col-xxs-12 col-xs-6 mt">
                                                <div class="input-field">
                                                    <label for="from">To:</label>
                                                    <input type="text" class="form-control"  id="from-place" name="to-place" placeholder="Tokyo, Japan"/>
                                                </div>
                                            </div>
                                            <div class="col-xxs-12 col-xs-6 mt alternate">
                                                <div class="input-field">
                                                    <label for="date-start">Check In:</label>
                                                    <input class="form-control datepicker" data-provide="datepicker" data-date-format="dd.mm.yyyy" name="date-start" placeholder="mm/dd/yyyy"/>
                                                </div>
                                            </div>
                                            <div class="col-xxs-12 col-xs-6 mt alternate">
                                                <div class="input-field">
                                                    <label for="date-end">Check Out:</label>
                                                    <input class="form-control datepicker" data-provide="datepicker" data-date-format="dd.mm.yyyy" name="date-end" placeholder="mm/dd/yyyy"/>
                                                </div>
                                            </div>
                                            <div class="col-xxs-12 col-xs-6 mt alternate">
                                                <section>
                                                    <label for="class">Class:</label>
                                                    <select class="cs-select cs-skin-border" name="flying-class">
...
$.ajax({
    ...
    success: function(xmlResponse) {
        var data = $("GeoCatalog", xmlResponse).map(function() {
            return {
